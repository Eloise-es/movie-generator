		...
		<Container fluid="sm" className="mt-3">
			<Row>
				<Col md>
					<MovieCard
						img={img1}
						imgAlt="a cat on a giant roll of toilet roll, surrounded by an audience"
						...
						actors={["Jim Carrey", "Tina Fey"]}
					/>
				</Col>
				<Col md>
					<MovieCard
						img={img2}
						imgAlt="Two men using laptops, smiling. You can see the city lights in the background"
				...
				<Col md>
					<MovieCard
						img={img3}
						imgAlt="a woman surrounded by plants"
